...
*/
//  ===================== CASE III  WITH FINAL LIST ======================================
// Array of initial guests
var guestListNew = ["Phool", "Afshaan Iqbal", "Maria Overseas", "Nelum Mandela"];
// Add one new guest to the middle of the array
guestListNew.splice(Math.ceil(guestListNew.length / 2), 0, "Gudiya Baji");
// Append one new guest to the end of the list
guestListNew.push("Huma Tahir");
// Print invitation messages for each person in the list
console.log("Invitation Messages:");
guestListNew.forEach(function (guest) { return console.log("Dear ".concat(guest, ", you are cordially invited to dinner. Please join us for an evening of good food and conversation.")); });
